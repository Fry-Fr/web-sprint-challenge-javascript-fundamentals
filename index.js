...
/* The nested function looks for a variable called "internal" which is located inside the function's lexical environment. */
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    const array = zooAnimals.map(item => item.animal_name.toLowerCase());
    return array
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const objs = zooAnimals.filter(item => item.population < 5);
    return objs
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    const totalPop = zooAnimals.reduce((total, item) => {return total + item.population},0);
    return totalPop
  }
...
const cuboidTwo = new CuboidMakerTwo(cuboid);
